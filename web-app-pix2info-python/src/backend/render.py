...
Layout: TypeAlias = Page.Layout
Block: TypeAlias = Page.Block
Table: TypeAlias = Page.Table
Barcode: TypeAlias = Page.DetectedBarcode
FormField: TypeAlias = Page.FormField
