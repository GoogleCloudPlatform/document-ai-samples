...
class DocAIBQConnector:
    ...
    def _augment_metadata_mapping_info(self, file_name=None, hitl_operation_id=None, doc_group_id=None, 
        ...
        if self.metadata_mapper is not None:
            ...
            self.metadata_mapper.set_default_value_for_metadata_if_not_set("doc_status", str(doc_status))
            self.metadata_mapper.set_default_value_for_metadata_if_not_set("doc_type", str(doc_type))
