...
def calculate_tax_values(data: dict) -> List[List]:
    ...
    line_8 = get_numerical_form_value(
        form_1099nec, 'NonemployeeCompensation') + get_numerical_form_value(form_1099misc, 'Rents')

    # Add lines 1, 2b, 3b, 4b, 5b, 6b, 7, and 8
    line_9 = line_1 + line_2b + line_3b + \
        line_4b + line_5b + line_6b + line_7 + line_8
    ...
    line_25b = get_numerical_form_value(form_1099div, 'FederalIncomeTaxWithheld') + \
    ...
    output_1040 = [
        ...
        ["8",
            "Other income from Schedule 1, line 9", line_8, f"{_FORM_1099NEC} & {_FORM_1099MISC}"],
        ["9", "Add lines 1, 2b, 3b, 4b, 5b, 6b, 7, and 8. This is your total income", line_9, ""],
        ...
        ["15", "Taxable income. Subtract line 14 from line 11. If zero or less, enter 0", line_15, ""],
        ["16", "Tax from Taxable Income", line_16, ""],
        ["24", "Total Tax", line_24, ""],
        ["25a", "Tax Withheld from Form W-2", line_25a, _FORM_W2],
        ["25b", "Tax Withheld from Form 1099(s)", line_25b,
    ...
    if line_33 > line_24:
        ...
        output_1040.append([
            line_37,
            "If line 33 is less than line 24, subtract line 33 from line 24. This is the amount you owe now",
            line_37
        ])
